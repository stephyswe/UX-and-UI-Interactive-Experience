		<div id="con">
			<div class="row">
			<h1>UX & UI Interactive Experience<h3>Use MouseWheel or Buttons to Zoom In / Out</h3></h1>
					...
					<table class="center">			
						<thead>
							...
							<tr>
								...
								<th><h2>Play</h2><i id="play" class="material-icons">play_arrow</i><i id="pause" class="material-icons">pause</i>
								</th>
							</tr>
							<tr>
				...
				<div class="col-md-12 col-xs-12" style="float:right;background-color:white;border:1px solid black;;overflow:hidden;height:550px;position:relative;">
					...
					<img src="assets/images/imagemap2-eng-3.png" usemap="#map" id="image" alt="Demo image for zoomable jQuery plugin" />
